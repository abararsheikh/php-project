...
<main>
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <table class="table1">
               <tr> <td rowspan="6" colspan="1" width="400"><img src="../../Assets/image/food/food1.jpg" width="340" height="220"/><div style="margin-top: 20px;"><label>Share:</label></div></td><td colspan="7"><h3>Good food</h3></td></tr>
            ...
            <div class="row">
                <div class="col-xs-6 col-md-3">
                    <a href="#" class="thumbnail">
                        <img src="../../Assets/image/food/food1.jpg" alt="...">
                    </a>
                    </div>
                    <div class="col-xs-6 col-md-3">
                    <a href="#" class="thumbnail">
