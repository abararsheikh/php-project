...
(function(jQuery) {
	...
	jQuery.fn.awShowcase = function(options) {
		...
		viewline:				false, /* If set to true content_width, thumbnails, transition and dynamic__height will be disabled. As for dynamic height you need to set the width and height of images in the source. */
		...
		if (options.thumbnails)
		{
			...
			else
			{
				...
				thumb_restriction.css('width',  (showcase_width-70)-buttonsWidth);
			}
