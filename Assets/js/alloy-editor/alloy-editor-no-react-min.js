...
(function(process) {
    ...
    function deployCKEditor() {
      (function() {
        ...
        window.CKEDITOR || (window.CKEDITOR = function() {
          var a = /(^|.*[\\\/])alloy-editor-no-react-min\.js(?:\?.*|;.*)?$/i,
              d = {
                timestamp: "FB9E",
                version: "4.5.6",
                revision: "91e81fe",
            ...
            on: function(b, d, g, h, l) {
              ...
              if (0 > f.getListenerIndex(d)) {
                ...
                for (var A = f.length - 1; 0 <= A; A--)
                  if (f[A].priority <= l)
                    return f.splice(A + 1, 0, q), {removeListener: t};
                f.unshift(q);
              }
          ...
          CKEDITOR.tools = {
            ...
            enableHtml5Elements: function(a, b) {
              for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
                  l = c.length,
                  d; l--; )
                d = a.createElement(c[l]), b && a.appendChild(d);
            },
            ...
            getCookie: function(a) {
              ...
              for (var b = document.cookie.split(";"),
                  ...
                  l,
                  d = 0; d < b.length; d++)
                if (c = b[d].split("\x3d"), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a)
            ...
            getCsrfToken: function() {
              ...
              if (!a || 40 != a.length) {
                ...
                for (c = 0; c < a.length; c++)
                  var l = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36),
        ...
        CKEDITOR.dtd = function() {
          var a = CKEDITOR.tools.extend,
              d = function(a, b) {
                for (var c = CKEDITOR.tools.clone(a),
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
          ...
          getAddress: function(a) {
            for (var d = [],
                b = this.getDocument().$.documentElement,
                c = this.$; c && c != b; ) {
              var e = c.parentNode;
          ...
          getIndex: function(a) {
            ...
            var b = this.$,
                c = -1,
                e;
            if (!this.$.parentNode || a && b.nodeType == CKEDITOR.NODE_TEXT && !b.nodeValue && !d(b) && !d(b, !0))
              return -1;
            do
              if (!a || b == this.$ || b.nodeType != CKEDITOR.NODE_TEXT || !e && b.nodeValue)
                c++, e = b.nodeType == CKEDITOR.NODE_TEXT;
 ...
 while (d = d.getParent());
          ...
          getPosition: function(a) {
            ...
            d = this.getAddress();
            a = a.getAddress();
            for (var b = Math.min(d.length, a.length),
                c = 0; c < b; c++)
              if (d[c] != a[c])
            ...
            for (var a; this.getFirst && (a = this.getFirst()); ) {
              if (a.type == CKEDITOR.NODE_TEXT) {
                var d = CKEDITOR.tools.ltrim(a.getText()),
                    b = a.getLength();
                if (d)
                  d.length < b && (a.split(b - d.length), this.$.removeChild(this.$.firstChild));
                else {
                  a.remove();
                  continue;
                }
            ...
            for (var a; this.getLast && (a = this.getLast()); ) {
              if (a.type == CKEDITOR.NODE_TEXT) {
                var d = CKEDITOR.tools.rtrim(a.getText()),
                    b = a.getLength();
                if (d)
                  d.length < b && (a.split(d.length), this.$.lastChild.parentNode.removeChild(this.$.lastChild));
                else {
                  a.remove();
                  continue;
                }
        ...
        (function() {
          ...
          function c(a) {
            for (var b = 0,
                c = 0,
                f = h[a].length; c < f; c++)
              b += parseInt(this.getComputedStyle(h[a][c]) || 0, 10) || 0;
            return b;
          }
          ...
          CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            isIdentical: function(a) {
              ...
              if (b.$.isEqualNode)
                return b.$.style.cssText = CKEDITOR.tools.normalizeCssText(b.$.style.cssText), a.$.style.cssText = CKEDITOR.tools.normalizeCssText(a.$.style.cssText), b.$.isEqualNode(a.$);
              b = b.getOuterHtml();
              a = a.getOuterHtml();
              ...
              function a(b, c, f) {
                if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                  for (var d = []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable(); )
                    if (d.push(c), c = f ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT)
                      return;
                  if (b.isIdentical(c)) {
                    for (var l = f ? b.getLast() : b.getFirst(); d.length; )
                      d.shift().move(b, !f);
                    c.moveChildren(b, !f);
                    c.remove();
            ...
            removeStyle: function(a) {
              ...
              if (b.removeProperty || "border" != a && "margin" != a && "padding" != a)
                b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
              else {
 ...
 while (b = b.getParent());
              ...
              for (var f = 0; f < c.length; f++) {
                ...
                if (!(e in b))
                  if ("checked" == e && (u = this.getAttribute(e)))
                    ...
                    u = this.getAttribute(e), null === u && (u = d.nodeValue), a.setAttribute(e, u);
              }
            ...
            getEditor: function() {
              var a = CKEDITOR.instances,
                  ...
                  c;
              for (b in a)
                if (c = a[b], c.element.equals(this) && c.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO)
                  return c;
              return null;
            },
            find: function(a) {
            ...
            forEach: function(a, b, c) {
              ...
              if (!1 !== f) {
                ...
                for (var d = 0; d < c.count(); d++)
                  f = c.getItem(d), f.type == CKEDITOR.NODE_ELEMENT ? f.forEach(a, b) : b && f.type != b || a(f);
              }
            }
          });
          var h = {
        ...
        (function() {
          ...
          function d(a, b, c, d, e) {
            ...
            function g() {
              var a,
                  b,
                  c,
                  f = Math.min(w.length, H.length);
              for (a = 0; a < f; a++)
                if (b = w[a], c = H[a], !b.equals(c))
                  return a;
              return a - 1;
            }
            function h() {
            ...
            var p = a.startContainer,
                ...
                M,
                S;
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n))
              p = a.document.createText(p.substring(D, r)), c.append(p);
            else {
              ...
              O = c;
              for (P = I; P <= J; P++)
                if (c = H[P], W = c.getPrevious(), c.equals(w[P]))
                  b && (O = O.getChild(0));
                else {
          ...
          CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function(a) {
              ...
              m || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(), e.collapse(), e.insertNode(c));
              e = this.clone();
              e.collapse(!0);
              e.insertNode(b);
            ...
            moveToBookmark: function(a) {
              if (a.is2) {
                ...
                b = (c = a.serializable) ? this.document.getById(a.startNode) : a.startNode, a = c ? this.document.getById(a.endNode) : a.endNode, this.setStartBefore(b), b.remove(), a ? (this.setEndBefore(a), a.remove()) : this.collapse(!0);
            },
              ...
              switch (a) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                  ...
                  for (k = c(k); k || p; ) {
                    if (k && !p) {
                      !n && k.equals(g) && (n = !0);
                      if (e ? k.isBlockBoundary() : !h.contains(k))
                        break;
                    ...
                    for (; p; )
                      if (r = !1, p.type == CKEDITOR.NODE_COMMENT)
                        ...
                        if (p.type == CKEDITOR.NODE_TEXT)
                          F = p.getText(), d.test(F) && (p = null), r = /[\s\ufeff]$/.test(F);
                          ...
                          if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                            ...
                            if (d.test(F))
                              ...
                              for (var B = p.$.getElementsByTagName("*"),
                                  t = 0,
                                  q; q = B[t++]; )
                  ...
                  for (; k || p; ) {
                    ...
                    for (; p; ) {
                      r = !1;
                      if (p.type == CKEDITOR.NODE_TEXT)
                        F = p.getText(), m(p, 0) || (p = null), r = /^[\s\ufeff]/.test(F);
            ...
            shrink: function(a, b, c) {
              if (!this.collapsed) {
                ...
                d.guard = function(b, d) {
                  if (k(b))
                    return !0;
                  if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(p) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))
                    return !1;
            ...
            removeEmptyBlocksAtEnd: function() {
              ...
              return function(b) {
                for (var c = this.createBookmark(),
                    ...
                    g; e && !e.equals(d.root) && !e.getFirst(a(e)); )
                  g = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = g;
                this.moveToBookmark(c);
              };
            }(),
            startPath: function() {
                ...
                for (; b; ) {
                  if (b.type == CKEDITOR.NODE_ELEMENT) {
                    if ("false" == b.getAttribute("contentEditable") && !b.data("cke-editable"))
                      return 0;
                    if (b.is("html") || "true" == b.getAttribute("contentEditable") && (b.contains(c) || b.equals(c)))
                      break;
                  }
                  b = b.getParent();
                }
            ...
            moveToElementEditablePosition: function(a, b) {
              if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1))
                return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START), !0;
              for (var c = 0; a; ) {
                if (a.type == CKEDITOR.NODE_TEXT) {
                ...
                if (a.type == CKEDITOR.NODE_ELEMENT)
                  if (a.isEditable())
                    this.moveToPosition(a, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_START), c = 1;
            ...
            getNextParagraph: function(a) {
              ...
              if (this._.nestedEditable) {
                ...
                if (b(this, a, this._.nestedEditable.container, this._.nestedEditable.remaining))
                  return this.activeFilter = this._.nestedEditable.iterator.activeFilter, this._.nestedEditable.iterator.getNextParagraph(a);
              ...
              for (this._.nextNode = null; y; ) {
                var E = 0,
                    ...
                    k = 0;
                if (x)
                  y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (x = 0);
                else {
                  var p = y.getName();
                  if (CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) {
                    ...
                    b(this, a, d);
                    break;
                  } else if (y.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                    if ("br" == p)
                      x = 1;
                ...
                if (h && !E)
                  for (; !y.getNext(l) && !A; ) {
                    p = y.getParent();
                    if (p.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                      E = 1;
                      x = 0;
                      A || p.equals(m);
              ...
              if (!d) {
                ...
                d = d.block;
                !d && y && !this.enforceRealBlocks && E[y.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !y.equals(h.root) ? d = y : !d || this.enforceRealBlocks && d.is(q) ? (d = this.range.document.createElement(a), h.extractContents().appendTo(d), d.trim(), h.insertNode(d), u = C = !0) : "li" != d.getName() ? h.checkStartOfBlock() && h.checkEndOfBlock() || (d = d.clone(!1), h.extractContents().appendTo(d), d.trim(), C = h.splitBlock(), u = !C.wasStartOfBlock, C = !C.wasEndOfBlock, h.insertNode(d)) : A || (this._.nextNode = d.equals(m) ? null : this._getNextSourceNode(h.getBoundaryNodes().endNode, 1, m));
              }
        ...
        (function() {
          function a(a, b, c, d, e) {
            ...
            for (k in b) {
              ...
              for (m in S) {
                ...
                x ? F = !1 : x = {};
                for (J in g)
                  "!" == J.charAt(0) && (J = J.slice(1), D.push(J), x[J] = !0, F = !1);
                for (; J = D.pop(); )
                  g[J] = g["!" + J], delete g["!" + J];
                G[f] = (F ? !1 : x) || null;
              }
            ...
            for (d = a.length; c < d; ++c) {
              ...
              for (m in w) {
                ...
                g = void 0;
                for (g in f)
                  -1 < g.indexOf("*") ? x.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : x.push(g);
                f = x;
                f.length && (n[r] = f, G = !1);
              }
              n.nothingRequired = G;
              n.noProperties = !(n.attributes || n.classes || n.styles);
              if (!0 === k.elements || null === k.elements)
                e[p ? "unshift" : "push"](k);
              else
                for (l in n = k.elements, delete k.elements, n)
                  if (b[l])
                    b[l][p ? "unshift" : "push"](k);
                  else
                    b[l] = [k];
            }
          }
          ...
          function h(a, b) {
            ...
            if (!0 === a)
              return a;
            if ("string" == typeof a)
              return a = T(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b));
            if (CKEDITOR.tools.isArray(a))
            ...
            if (k = a.requiredClasses)
              for (p = b.classes, c = 0; c < k.length; ++c)
                if (d = k[c], "string" == typeof d) {
                  if (-1 == CKEDITOR.tools.indexOf(p, d))
                    return !1;
          ...
          function f(a) {
            var b,
                ...
                p = {},
                e = 1;
            for (a = T(a); b = a.match(H); )
              (c = b[2]) ? (d = z(c, "styles"), k = z(c, "attrs"), c = z(c, "classes")) : d = k = c = null, p["$" + e++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: k
            ...
            if (e.doFilter) {
              a: {
                ...
                if (a || r) {
                  ...
                  if (x)
                    for (w = 0, h = x.length; w < h; ++w)
                      c(x[w], b, D);
                  if (a)
                    for (w = 0, h = a.length; w < h; ++w)
                      d(a[w], b, D, g);
                  if (r)
              ...
              if (!a.allAttributes)
                for (B in f)
                  h[B] || (L.test(B) ? B == (H = B.replace(/^data-cke-saved-/, "")) || h[H] || (delete f[B], w = !0) : (delete f[B], w = !0));
              if (!a.allStyles || a.hadInvalidStyle) {
                for (B in l)
                  a.allStyles || F[B] ? O.push(B + ":" + l[B]) : w = !0;
                O.length && (f.style = O.sort().join("; "));
              } else
                I && (f.style = I);
              if (!a.allClasses || a.hadInvalidClass) {
                for (B = 0; B < x.length; ++B)
                  (a.allClasses || r[x[B]]) && D.push(x[B]);
                D.length && (f["class"] = D.sort().join(" "));
                g && D.length < g.split(/\s+/).length && (w = !0);
              } else
                g && (f["class"] = g);
              w && (n = 1);
              if (!e.skipFinalValidation && !y(b))
                return k.push(b), 1;
            }
          ...
          function k(a, b, c) {
            ...
            if (B.$empty[d] || !a.children.length)
              "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({
                check: "it",
                el: a.parent
              }), a.remove());
            else if (B.$block[d] || "tr" == d)
              if ("br" == b)
                a.previous && !x(a.previous) && (b = v(), b.insertBefore(a)), a.next && !x(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren();
              else {
                var d = a.children,
                    k;
                b: {
                ...
                if (k)
                  a.name = b, a.attributes = {}, c.push({
                    check: "parent-down",
                    el: a
                  });
                else {
                  k = a.parent;
                  for (var e = k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == k.name,
                      r,
                      f,
                      p = d.length; 0 < p; )
                    n = d[--p], e && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && B.$inline[n.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
                      check: "parent-down",
                      el: r
          ...
          CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
              ...
              !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(M[a.enterMode] + " " + M[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent));
            } else
              this.customConfig = !1, this.allow(a, "default", 1);
          };
          ...
          CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
              ...
              for (; x = a.pop(); )
                if (c = x.el, c.parent)
                  switch (g = B[c.parent.name] || B.span, x.check) {
                    case "it":
            ...
            addContentForms: function(a) {
              if (!this.disabled && a) {
                ...
                for (b = 0; b < a.length && !k; ++b)
                  c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (k = c);
                if (k) {
              ...
              if (!this.disabled && a) {
                ...
                for (k = 0; k < a.length; ++k) {
                  ...
                  for (p = 0; p < b.length; ++p)
                    n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], x = null, m = n[1]) : (f = n.check, x = n.left, m = n.right), e || (e = n, e = e.element ? e.element : f ? f.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element), x instanceof CKEDITOR.style && (x = r(x)), c.push({
                      check: f == e ? null : f,
                      left: x,
            ...
            check: function(a, b, c) {
              ...
              if ("string" == typeof a) {
                ...
                d = a.getDefinition(), k = d.styles, n = d.attributes || {}, k ? (k = L(k), n.style = CKEDITOR.tools.writeCssText(k, !0)) : k = {}, k = {
                  name: d.element,
                  attributes: n,
              ...
              O = CKEDITOR.filter.transformationsTools = {
                ...
                transform: function(a, b) {
                  if ("string" == typeof b)
                    ...
                    for (e in k)
                      if ("class" == e)
                        for (c = a.classes.join("|"), n = k[e].split(/\s+/); r = n.pop(); )
                        ...
                        if (!(1 < e.length)) {
                          ...
                          c && (CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? f.$.onreadystatechange = function() {
                            if ("loaded" == f.$.readyState || "complete" == f.$.readyState)
                              f.$.onreadystatechange = null, A(b, !0);
                          } : (f.$.onload = function() {
                            setTimeout(function() {
                              A(b, !0);
                            }, 0);
        ...
        CKEDITOR.resourceManager.prototype = {
          ...
          load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) {
              if (e.length)
                throw Error('[CKEDITOR.resourceManager.load] Resource name "' + h[e[0]].join(",") + '" was not found at "' + e[0] + '".');
                ...
                h = function(b) {
                  a.call(this, b, function(a) {
                    ...
                    for (f in a) {
                      ...
                      if (!d[f]) {
                        if (l.icons)
                          for (var u = l.icons.split(","),
                              C = u.length; C--; )
                            CKEDITOR.skin.addIcon(u[C], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + u[C] + ".png");
                        d[f] = 1;
                      }
                      if (A)
                        for (A.split && (A = A.split(",")), l = 0; l < A.length; l++)
                          g[A[l]] || b.push(A[l]);
                    }
                    if (b.length)
                      h.call(this, b);
                      ...
                      for (f in g)
                        l = g[f], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[f], l.onLoad._called = 1);
                      c && c.call(e || window, g);
                    }
                  }, this);
                };
 ...
 while (CKEDITOR.instances[a]);
          ...
          function g(a, b, c) {
            if (b) {
              var d,
                  ...
                  k = a.commands;
              for (e in k)
                d = k[e], (c || d.contextSensitive) && d.refresh(a, b);
            }
          }
          function h(a) {
          ...
          function z(a) {
            var b = a.config,
                ...
                e = b.removePlugins;
            if (d)
              var k = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                  c = c.replace(k, ""),
                  c = c + ("," + d);
            if (e)
              var p = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"),
                  c = c.replace(p, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
              ...
              CKEDITOR.scriptLoader.load(e, function() {
                for (var c = ["beforeInit", "init", "afterInit"],
                    e = 0; e < c.length; e++)
                ...
                for (p = 0; p < a.config.blockedKeystrokes.length; p++)
                  a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[p]] = 1;
                a.status = "loaded";
                a.fireOnce("loaded");
          ...
          CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            setActiveEnterMode: function(a, b) {
              ...
              if (this.activeEnterMode != a || this.activeShiftEnterMode != b)
                this.activeEnterMode = a, this.activeShiftEnterMode = b, this.fire("activeEnterModeChange");
            },
        ...
        (function() {
          ...
          CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
              ...
              if (b.length > g)
                this.onText(b.substring(g, b.length));
            }
          };
        })();
          ...
          CKEDITOR.htmlParser.fragment.fromHtml = function(g, h, l) {
                ...
                if ("br" == e)
                  ...
                  for (; !(r = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || v.isUnknown || r[e]); )
                    if (v.isOptionalClose)
                      ...
                      f = v.children, (f = f[f.length - 1]) && "li" == f.name || z(f = new CKEDITOR.htmlParser.element("li"), v), !n.returnPoint && (n.returnPoint = v), v = f;
                    else if (e in CKEDITOR.dtd.$listItem && !u(e, f))
                      C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
                    else if (f in d && !u(e, f))
                      !n.returnPoint && (n.returnPoint = v), v = v.parent;
                    else if (f in CKEDITOR.dtd.$inline && y.unshift(v), v.parent)
                      z(v, v.parent, 1);
                    else {
                      n.isOrphan = 1;
                      break;
            ...
            C.onTagClose = function(a) {
              ...
              for (var c = [],
                  d = [],
                  k = v; k != m && k.name != a; )
                k._.isBlockLike || d.unshift(k), c.push(k), k = k.returnPoint || k.parent;
              if (k != m) {
            ...
            C.onText = function(a) {
              if (!(v._.hasInlineStarted && !E.length || k || x) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))
                return;
              var b = v.name,
                  f = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
              if (!x && !f["#"] && b in d)
                C.onTagOpen(e[b] || ""), C.onText(a);
              else {
                t();
                q();
                k || x || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        (function() {
          ...
          function d(b, c, d, g) {
            var h,
                l;
            for (h in c)
              (l = b[h]) || (l = b[h] = new a), l.add(c[h], d, g);
          }
          CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
              ...
              onElement: function(a, c) {
                for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$],
                    g,
                    h = 0; 3 > h; h++)
                  if (g = d[h]) {
                    g = g.exec(a, c, this);
          ...
          a.prototype = {
            ...
            findIndex: function(a) {
              for (var c = this.rules,
                  d = c.length - 1; 0 <= d && a < c[d].priority; )
                d--;
              return d + 1;
            },
            exec: function(a, c) {
              var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                  ...
                  z;
              for (z = 0; z < l; z++)
                if (d && (q = c.type, t = c.name), f = h[z], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
                  f = f.value.apply(null, g);
                  if (!1 === f || d && f && (f.name != t || f.type != q))
                    return f;
                  null != f && (g[0] = c = f);
                }
              return c;
            ...
            execOnName: function(a, c) {
              for (var d = 0,
                  ...
                  h = g.length,
                  l; c && d < h; d++)
                l = g[d], a.nonEditable && !l.options.applyToAll || a.nestedEditable && l.options.excludeNestedEditable || (c = c.replace(l.value[0], l.value[1]));
              return c;
            }
          };
        })();
        (function() {
          function a(a, d) {
                ...
                if (k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                  ...
                  if (p)
                    for (f(p, 1) && e.push(p); p; )
                      g(p) && (r = c(p)) && f(r) && ((w = c(r)) && !g(w) ? e.push(r) : (n(x).insertAfter(r), r.remove())), p = p.previous;
                  for (p = 0; p < e.length; p++)
                    e[p].remove();
                  if (e = !a || !1 !== ("function" == typeof d ? d(k) : d))
                    x || CKEDITOR.env.needsBrFiller || k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? x || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || k.name in CKEDITOR.dtd.tr || k.name in CKEDITOR.dtd.$listItem) ? (e = b(k), e = !e || "form" == k.name && "input" == e.name) : e = !1 : e = !1;
                  e && k.add(n(a));
                }
              };
            }
            function f(a, b) {
              if ((!x || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"])
                return !0;
              var c;
              return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && x && (!b || a.parent.name in w) || !x && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1;
            }
            var r = {elements: {}},
                x = "html" == d,
            ...
            for (D in w)
              "#" in v[D] || delete w[D];
            for (D in w)
              r.elements[D] = p(x, a.config.fillEmptyBlocks);
            r.root = p(x, !1);
          ...
          function t(a) {
            return a.replace(F, function(a, b, c) {
          ...
          var y = /(?:&nbsp;|\xa0)$/,
              ...
              n = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]},
              D = {elements: {
                  embed: function(a) {
                    var b = a.parent;
                    if (b && "object" == b.name) {
                  ...
                  $: function(a) {
                    ...
                    if (b) {
                      ...
                      for (var c = ["name", "href", "src"],
                          d,
                          k = 0; k < c.length; k++)
                        d = "data-cke-saved-" + c[k], d in b && delete b[c[k]];
                    }
                    return a;
                  },
                  table: function(a) {
                    a.children.slice(0).sort(function(a, b) {
                      var c,
                          d;
                      a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(x, a.name), d = CKEDITOR.tools.indexOf(x, b.name));
        ...
        (function() {
          ...
          CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            split: function(a) {
              for (var b = this.children.splice(a, this.children.length - a),
                  d = this.clone(),
                  h = 0; h < b.length; ++h)
                b[h].parent = d;
              d.children = b;
          ...
          CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
              for (var c = CKEDITOR.document.getElementsByTag(b),
                  e = 0,
                  g = c.count(); e < g; e++)
                a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (d = {
                  element: a,
                  config: {}
            ...
            for (var a = document.getElementsByTagName("textarea"),
              ...
              if (h.name || h.id) {
                if ("string" == typeof arguments[0]) {
                  if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(h.className))
                    continue;
                } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](h, d)))
                  continue;
                this.replace(h, d);
              }
            }
        ...
        (function() {
          function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
              if (f = d(f, e))
                f.appendBogus(), F = CKEDITOR.env.ie;
          ...
          function g(a) {
            ...
            if (e.startPath().contains(f)) {
              ...
              a.checkBackward();
              if (d)
                return r = e.clone(), r.collapse(), r.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(r), a.guard = b(!0), d = !1, a.checkForward(), d;
            }
            return null;
          }
          function h(a, b, c) {
            ...
            proto: {
              ...
              insertElementIntoRange: function(a, b) {
                ...
                var h,
                    g;
                if (f)
                  for (; (h = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[h.getName()]) && (!g || !g[e]); )
                    h.getName() in CKEDITOR.dtd.span ? b.splitElement(h) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h), b.collapse(!0), h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                b.insertNode(a);
                return !0;
              },
              ...
              extractHtmlFromRange: function(a, b) {
                ...
                if (b) {
                  ...
                  c.autoParagraph(this.editor, a), A(a.startContainer) && a.startContainer.appendBogus();
                  ...
                  CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                    ...
                    if (b in h) {
                      ...
                      if (d.collapsed)
                        ...
                        c = d, f = b.block, d = c.endPath().block, f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (k = f.getBogus()) && k.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), t(f, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                      if (!b)
                        return;
          ...
          var f = CKEDITOR.dom.walker.whitespaces(!0),
              ...
              m = function() {
                ...
                function b(c, d) {
                  ...
                  for (var r = B[r.getName()],
                      ...
                      m = -1,
                      t = 0,
                      q = e.contains(B.$list); g < l; ++g)
                    e = D.getItem(g), a(e) ? (n = e.getName(), q && n in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !!r[n], "br" != n || !e.data("cke-eol") || g && g != l - 1 || (t = (f = g ? h[g - 1].node : D.getItem(g + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && B.$block[f.getName()]), -1 != F || p || (F = g), p || (m = g), h.push({
                      isElement: 1,
                      isLineBreak: t,
                  ...
                  -1 < F && (h[F].firstNotAllowed = 1);
                  -1 < m && (h[m].lastNotAllowed = 1);
                  return h;
                }
                function d(b, c) {
                  var e = [],
                  ...
                  for (g && e.push(" "); h < f; h++)
                    n = k.getItem(h), a(n) && !n.is(r) ? e = e.concat(d(n, c)) : e.push(n);
                  g && e.push(" ");
                  return e;
                }
                function e(b) {
                ...
                return function(m, w, H, I) {
                  ...
                  if (!I.checkReadOnly()) {
                    ...
                    for (; (u = e(w)) && a(u) && u.isBlockBoundary() && J.contains(u); )
                      w.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
                    r(w, m.blockLimit, J, L);
                    K && (w.setEndBefore(K), w.collapse(), K.remove());
                    K = w.startPath();
                    if (G = K.contains(f, !1, 1))
                      w.splitElement(G), m.inlineStylesRoot = G, m.inlineStylesPeak = K.lastElement;
                    K = w.createBookmark();
                    (G = K.startNode.getPrevious(c)) && a(G) && f(G) && I.push(G);
                    (G = K.startNode.getNext(c)) && a(G) && f(G) && I.push(G);
                    for (G = K.startNode; (G = G.getParent()) && f(G); )
                      I.push(G);
                    w.moveToBookmark(K);
                    if (K = H) {
                      K = m.range;
                      if ("text" == m.type && m.inlineStylesRoot) {
                        ...
                        for (I = m.inlineStylesRoot.getParent(); !u.equals(I); )
                          w = w.appendTo(u.clone()), u = u.getParent();
                      ...
                      if ((A = K.startPath().block) && (1 != A.getChildCount() || !A.getBogus()))
                        a: {
                          var z;
                      ...
                      for (g(w, z); I < w.length; I++) {
                        ...
                        if (v)
                          ...
                          if (G && L.isElement) {
                            ...
                            if (v)
                              R && (X = z.splitElement(R), m.zombies.push(X), m.zombies.push(R));
                            else {
                              R = u.getName();
                              Y = !I;
                              v = I == w.length - 1;
                              ...
                              for (var U = [],
                                  ...
                                  Z = 0,
                                  V = -1; ca < ba; ca++)
                                ea = R[ca], " " == ea ? (Z || Y && !ca || (U.push(new CKEDITOR.dom.text(" ")), V = U.length), Z = 1) : (U.push(ea), Z = 0);
                              v && V == U.length && U.pop();
                              Y = U;
                            }
                          }
                    ...
                    for (Y = C.createBookmark(); N = m.zombies.pop(); )
                      N.getParent() && (E = C.clone(), E.moveToElementEditStart(N), E.removeEmptyBlocksAtEnd());
                    if (X)
                      for (; N = X.pop(); )
                        CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(C.document.createText(" "));
                    for (; N = m.mergeCandidates.pop(); )
                      N.mergeSiblings();
                    C.moveToBookmark(Y);
                    if (!m.dontMoveCaret) {
                      for (N = e(C); N && a(N) && !N.is(B.$empty); ) {
                        if (N.isBlockBoundary())
                          C.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END);
                        else {
              ...
              y = function() {
                ...
                return function(d) {
                  ...
                  f.setStart(e, 0);
                  f = a(f).lastBackward();
                  f || (f = d.clone(), f.setEndAt(e, CKEDITOR.POSITION_BEFORE_END), f = a(f).lastForward(), h = !0);
                  f || (f = e);
                ...
                eol: {
                  detect: function(a, b) {
                    var c = a.range,
                        ...
                        h = new CKEDITOR.dom.elementPath(c.endContainer, b);
                    d.collapse(1);
                    e.collapse();
                  ...
                  list: {
                    detectMerge: function(a, b) {
                      ...
                      if (a.mergeList || a.mergeListItems)
                        d = d.clone(), d.setStartBefore(a.bookmark.startNode), d.setEndAfter(a.bookmark.endNode), a.mergeListBookmark = d.createBookmark();
                    },
                    merge: function(a, c) {
                    ...
                    function a(c) {
                      ...
                      k.guard = function(a, k) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) {
                          ...
                          if (a.getCustomData(g))
                            return;
                          CKEDITOR.dom.element.setMarker(p, a, g, 1);
                        }
                        if (k && h && a.equals(h))
                          f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f);
                        else if (!k && n && a.equals(n))
                          f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f);
                        else {
                          if (g = !k)
                            g = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!n || b(a, n));
                    ...
                    return {
                      ...
                      deleteRanges: function(a) {
                        for (var b; b = a.tableContentsRanges.pop(); )
                          b.extractContents(), A(b.startContainer) && b.startContainer.appendBogus();
        ...
        (function() {
          function a() {
            ...
            if (!a && (a = b || this.getSelection(1), !a || a.getType() == CKEDITOR.SELECTION_NONE))
              return;
              ...
              if (!c.collapsed) {
                if (c.startContainer.isReadOnly())
                  for (var d = c.startContainer,
                      e; d && !((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly()); )
          ...
          CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
              ...
              if (CKEDITOR.env.ie || m)
                E ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                  e.lockSelection(H);
                  w = 1;
            ...
            if (CKEDITOR.env.ie9Compat)
              e.on("beforeDestroy", c, null, null, 9);
          ...
          CKEDITOR.dom.selection = function(a) {
            ...
            this._ = {cache: {}};
            if (b)
              return CKEDITOR.tools.extend(this._.cache, b._.cache), this.isFake = b.isFake, this.isLocked = b.isLocked, this;
            a = this.getNative();
            var d,
                e;
            if (a)
              ...
              var a = E ? function() {
                ...
                var b = function(b, c) {
                  ...
                  for (var e = d.children,
                      ...
                      n,
                      m; g <= w; )
                    if (l = Math.floor((g + w) / 2), f = e[l], h.moveToElementText(f), n = h.compareEndPoints("StartToStart", b), 0 < n)
                      w = l - 1;
                    else if (0 > n)
                      g = l + 1;
                    else
                  ...
                  if (-1 == l || l == e.length - 1 && 0 > n) {
                    ...
                    e = d.childNodes;
                    if (!h)
                      return f = e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? {
                        container: d,
                        offset: e.length
                      } : {
                        container: f,
                    ...
                    for (d = e.length; 0 < h && 0 < d; )
                      k = e[--d], k.nodeType == CKEDITOR.NODE_TEXT && (m = k, h -= k.nodeValue.length);
                    return {
                      container: m,
                      offset: -h
                    };
                ...
                return function() {
                  ...
                  if (d == CKEDITOR.SELECTION_TEXT)
                    return a = new CKEDITOR.dom.range(this.root), d = b(c, !0), a.setStart(new CKEDITOR.dom.node(d.container), d.offset), d = b(c), a.setEnd(new CKEDITOR.dom.node(d.container), d.offset), a.endContainer.getPosition(a.startContainer) & CKEDITOR.POSITION_PRECEDING && a.endOffset <= a.startContainer.getIndex() && a.collapse(), [a];
                  if (d == CKEDITOR.SELECTION_ELEMENT) {
                    for (var d = [],
                      ...
                      for (var f = c.item(e),
                          k = f.parentNode,
                          h = 0,
                          a = new CKEDITOR.dom.range(this.root); h < k.childNodes.length && k.childNodes[h] != f; h++)
                        ;
            ...
            getSelectedElement: function() {
              ...
              var b = this,
                  c = CKEDITOR.tools.tryThese(function() {
                    ...
                    for (var a = b.getRanges()[0].clone(),
                        c,
                        d,
                        e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && x[c.getName()] && (d = c)); e--)
            ...
            selectRanges: function(a) {
              ...
              if (b)
                for (var b = this.root,
                    c,
                    d = 0; d < a.length; ++d)
                  c = a[d], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount()));
              if (a.length)
                if (this.isLocked) {
                  ...
                  a: {
                    var l,
                        m;
                    if (1 == a.length && !(m = a[0]).collapsed && (g = m.getEnclosedNode()) && g.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(), m.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (g = l), "false" == g.getAttribute("contenteditable")))
                      break a;
                    g = void 0;
                  }
                  if (g)
                    ...
                    if (E) {
                      ...
                      var t,
                          q,
                          u;
                      if ((c = g.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in x && (!c.is("a") || !c.getText()))
                        try {
                      ...
                      if (g.startContainer.type == CKEDITOR.NODE_ELEMENT && g.startContainer.getName() in b || g.endContainer.type == CKEDITOR.NODE_ELEMENT && g.endContainer.getName() in b)
                        g.shrink(CKEDITOR.NODE_ELEMENT, !0), a = g.collapsed;
                      u = g.createBookmark();
                      b = u.startNode;
                      a || (f = u.endNode);
                      ...
                      f ? (l = g.document.$.body.createTextRange(), l.moveToElementText(f.$), u.setEndPoint("EndToEnd", l), u.moveEnd("character", -1)) : (t = b.getNext(m), q = b.hasAscendant("pre"), t = !(t && t.getText && t.getText().match(l)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), q = g.document.createElement("span"), q.setHtml("\x26#65279;"), q.insertBefore(b), t && g.document.createText("﻿").insertBefore(b));
                      g.setStartBefore(b);
                      b.remove();
                      ...
                      for (u = 0; u < a.length; u++) {
                        if (u < a.length - 1 && (t = a[u], q = a[u + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(q.startContainer, q.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), g = l.getCommonAncestor(), l = l.getEnclosedNode(), g.isReadOnly() || l && l.isReadOnly()))) {
                        ...
                        try {
                          ...
                          if (0 <= H.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                            g.collapse(1), q.setEnd(g.endContainer.$, g.endOffset);
                          else
                            throw H;
                        }
                        f.addRange(q);
        ...
        (function() {
          ...
          function b(c) {
            var f = c.document;
            if (c.collapsed)
              f = E(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
            else {
              var h = this.element,
                  g = this._.definition,
                  k,
                ...
                if (r.equals(q))
                  ...
                  if (x && m && CKEDITOR.dtd.$block[v])
                    for (var A = r,
                        ...
                        D = y.length,
                        F = 0,
                        A = D && new CKEDITOR.dom.range(A.getDocument()); F < D; ++F) {
                      var B = y[F],
                          T = CKEDITOR.filter.instances[B.data("cke-filter")];
                      if (T ? T.check(this) : 1)
                        A.selectNodeContents(B), b.call(this, A);
                    }
                  y = v ? !n[v] || z ? 0 : x && !m ? 0 : d(r, q, g, M) : 1;
                  if (y)
                    if (B = r.getParent(), y = g, D = h, F = k, !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !F || y.parentRule && !y.parentRule(B))
                      l = !0;
                    else {
                      if (u || v && CKEDITOR.dtd.$removeEmpty[v] && (r.getPosition(q) | M) != M || (u = c.clone(), u.setStartBefore(r)), v = r.type, v == CKEDITOR.NODE_TEXT || x || v == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                        for (var v = r,
                            Z; (l = !v.getNext(L)) && (Z = v.getParent(), n[Z.getName()]) && d(Z, t, g, S); )
                          v = Z;
                        u.setEndAfter(v);
                      }
                    }
                  ...
                  for (var l = E(this, f),
                    ...
                    if (z.getName() == h) {
                      for (V in g.attributes)
                        !D[V] && (da = z.getAttribute(Q)) && (l.getAttribute(V) == da ? y[V] = 1 : D[V] = 1);
                      for (Q in g.styles)
                        !B[Q] && (da = z.getStyle(Q)) && (l.getStyle(Q) == da ? v[Q] = 1 : B[Q] = 1);
                    }
                    z = z.getParent();
                  }
                  for (V in y)
          ...
          function c(a) {
            ...
            var c = a.createBookmark(),
                d = c.startNode;
            if (a.collapsed) {
              for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
                  f,
                  h = 0,
                  g; h < e.elements.length && (g = e.elements[h]) && g != e.block && g != e.blockLimit; h++)
              ...
              b();
              for (e = d; !e.equals(n); )
                f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? u.call(this, e) : m(e, k(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f;
            }
            a.moveToBookmark(c);
          ...
          function l(a) {
            ...
            for (var d,
                e = a.document,
                f; d = c.getNextParagraph(); )
              !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = E(this, e, d), t(d, f));
            a.moveToBookmark(b);
          }
          function q(a) {
            ...
            for (var d,
                e; d = c.getNextParagraph(); )
              this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), t(d, e)) : u.call(this, d));
            a.moveToBookmark(b);
          }
          function t(a, b) {
            var c = !b;
          ...
          function u(a, b) {
            var c = this._.definition,
                ...
                g;
            for (g in d)
              if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == p(g, d[g]))
                b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
            for (var h in c)
              this._.definition.fullMatch && a.getStyle(h) != p(h, c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
            m(a, e, D[a.getName()]);
          ...
          function y(a, b) {
            if (!a.hasAttributes() || b)
              if (CKEDITOR.dtd.$block[a.getName()]) {
                ...
                c = a.getFirst(), d = a.getLast(), a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(), d && !c.equals(d) && d.type == CKEDITOR.NODE_ELEMENT && d.mergeSiblings());
          }
          function E(a, b, c) {
            var d;
            d = a.element;
          ...
          function x(a, b) {
            for (var c in a)
              a[c] = a[c].replace(B, function(a, c) {
                return b[c];
              });
          }
          function k(a) {
          ...
          function n(a, b, c) {
            ...
            for (var f,
                g = e.createIterator(); f = g.getNextRange(); )
              b.call(this, f, c);
            a.selectRanges(e);
          ...
          CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
              if (q.type == CKEDITOR.NODE_ELEMENT) {
                l.push(q);
                if (!this.lastElement && (this.lastElement = q, q.is(CKEDITOR.dtd.$object) || "false" == q.getAttribute("contenteditable")))
                  continue;
                if (q.equals(e))
                  break;
                if (!h && (t = q.getName(), "true" == q.getAttribute("contenteditable") ? h = q : !g && d[t] && (g = q), a[t])) {
                  if (t = !g && "div" == t) {
                    a: {
                      t = q.getChildren();
                      for (var f = 0,
            ...
            createIterator: function() {
              ...
              return {getNextRange: function(h) {
                  ...
                  if (l && 1 < a.length) {
                    ...
                    for (l.moveToBookmark(d.shift()); t--; )
                      q = a[++g], q.moveToBookmark(d.shift()), l.setEnd(q.endContainer, q.endOffset);
                  }
                  return l;
                }};
            },
        ...
        CKEDITOR.plugins.add("dialogui", {onLoad: function() {
            var h = function(b) {
              ...
              return this._;
                ...
                r = CKEDITOR.tools.extend({}, CKEDITOR.ui.dialog.uiElement.prototype.eventProcessors, {onChange: function(b, a) {
              ...
              select: function(b, a, d) {
                if (!(3 > arguments.length)) {
                  ...
                  CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                    ...
                    t(c);
                    for (var k = 0,
                        l; k < a.items.length && (l = a.items[k]); k++)
 ...
 while (c = c._.parentDialog);
            ...
            function e(b) {
              if (l == CKEDITOR.dialog._.currentTop) {
                ...
                if (9 == c || c == CKEDITOR.SHIFT + 9)
                  ...
                  l._.tabBarMode = !0, l._.tabs[l._.currentTabId][0].focus(), l._.currentFocusIndex = -1, q = 1;
                else if (-1 != CKEDITOR.tools.indexOf(g, c) && l._.tabBarMode)
                  c = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c) ? x.call(l) : A.call(l), l.selectPage(c), l._.tabs[c][0].focus(), q = 1;
                else if (13 != c && 32 != c || !l._.tabBarMode)
                  if (13 == c)
                    c = b.data.getTarget(), c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), q = 1), n = 1;
                  else if (27 == c)
                    (c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), n = 1;
                  else
                    return;
                else
                  this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, d(1), q = 1;
                f(b);
              }
            }
            function f(a) {
          ...
          CKEDITOR.dialog.prototype = {
            ...
            move: function(a, b, c) {
              ...
              f && this._.position && this._.position.x == a && this._.position.y == b || (this._.position = {
                x: a,
                y: b
              }, f || (f = CKEDITOR.document.getWindow().getScrollPosition(), a += f.x, b += f.y), e && (f = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width - f.width - a), b = {top: (0 < b ? b : 0) + "px"}, b[e ? "right" : "left"] = (0 < a ? a : 0) + "px", d.setStyles(b), c && (this._.moved = 1));
            },
            ...
            setState: function(a) {
              if (this.state != a) {
                ...
                if (a == CKEDITOR.DIALOG_STATE_BUSY) {
                  ...
                  a == CKEDITOR.DIALOG_STATE_IDLE && (this.parts.spinner && this.parts.spinner.hide(), this.getButton("ok").enable());
                this.fire("state", a);
              }
            }
          };
        ...
        (function() {
          ...
          function D() {
            ...
            return {get: function(c) {
                return "plain-text" == c ? a.plainText || (a.plainText = new CKEDITOR.filter("br")) : "semantic-content" == c ? ((c = a.semanticContent) || (c = new CKEDITOR.filter, c.allow({$1: {
                    elements: b(),
                    attributes: !0,
                    styles: !1,
                    classes: !1
            ...
            init: function(b) {
              ...
              b.on("paste", function(a) {
                ...
                if (!a.data.dataValue) {
                  ...
                  if (g)
                    a.data.dataValue = g, a.data.type = "html";
                  else if (g = c.getData("text/plain"))
                    a.data.dataValue = b.editable().transformPlainTextToHtml(g), a.data.type = "text";
                }
              }, null, null, 1);
              b.on("paste", function(a) {
          ...
          CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function(b, a, c, d) {
              function e(b, c, d) {
                ...
                if (e.equals(c) && d != c.getChildCount())
                  return b = a.startContainer.getChild(a.startOffset - 1), c = a.startContainer.getChild(a.startOffset), b && b.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = b.getLength(), b.setText(b.getText() + c.getText()), c.remove(), a.setStart(b, d), a.collapse(!0)), !0;
              }
            ...
            getRangeAtDropPosition: function(b, a) {
              ...
              if (document.caretRangeFromPoint)
                c = a.document.$.caretRangeFromPoint(d, e), f.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), f.collapse(!0);
              else if (c.rangeParent)
                f.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), f.collapse(!0);
              else {
              ...
              if (a = a || v(b)) {
                ...
                if (k && m) {
                  if (c && (c.is("li") || c.getParent().is("li"))) {
                    ...
                    if (e.is("li"))
                      h || p ? (h && p && a.remove(), c[p ? "insertAfter" : "insertBefore"](e)) : c.breakParent(e);
                    else {
                      if (b)
                        if (l.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), q && e.setAttribute("dir", k), r && e.setAttribute("style", r), m && e.setAttribute("class", m), c.moveChildren(e)) : e = l.block, h || p)
                ...
                for (var n = new CKEDITOR.dom.walker(f),
                  ...
                  if (c.type == CKEDITOR.NODE_ELEMENT)
                    if (!c.equals(l) && c.getDirection())
                      ...
                      if (d)
                        for (var g = "ltr" == b.data.dir ? ["_rtl", ""] : ["", "_rtl"],
                            h = 0; h < d.length; h++)
        ...
        (function() {
          function w(c) {
            function f(b) {
              for (var e = d.startContainer,
                  a = d.endContainer; e && !e.getParent().equals(b); )
                e = e.getParent();
              ...
              if (!l.isIndent) {
                ...
                if ((f = b.getParent()) && f.is("li"))
                  for (var g = e.listNode.getChildren(),
                      r = [],
                      m,
                      a = g.count() - 1; 0 <= a; a--)
              ...
              if (r && r.length)
                for (a = 0; a < r.length; a++) {
                  for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName() in p; )
                    CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(d.document.createText(" ")), b.append(m);
                  b.insertAfter(f);
                }
          ...
          CKEDITOR.plugins.add("indentlist", {
            ...
            init: function(c) {
              ...
              CKEDITOR.tools.extend(f.prototype, l.specificDefinition.prototype, {context: {
                  ol: 1,
                  ul: 1
                }});
            }
        ...
        (function() {
          ...
          function g(a, c, b) {
            ...
            this.allowedContent = {"caption div h1 h2 h3 h4 h5 h6 p pre td th li": {
                propertiesOnly: !0,
          ...
          function l(a) {
            ...
            for (var h = new CKEDITOR.dom.walker(b),
                d; d = h.next(); )
              if (d.type == CKEDITOR.NODE_ELEMENT)
        ...
        (function() {
          function I(b, m, e) {
            function c(c) {
              if (!(!(a = d[c ? "getFirst" : "getLast"]()) || a.is && a.isBlockBoundary() || !(p = m.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || p.is && p.isBlockBoundary({br: 1})))
                b.document.createElement("br")[c ? "insertBefore" : "insertAfter"](a);
            }
            for (var f = CKEDITOR.plugins.list.listToArray(m.root, e),
                g = [],
                k = 0; k < m.contents.length; k++) {
              var h = m.contents[k];
            ...
            arrayToList: function(b, m, e, c, f) {
              ...
              for (var g,
                ...
                if (r.indent == p) {
                  ...
                  r = b[a - 1].element.getDirection(1), a = CKEDITOR.plugins.list.arrayToList(b, null, a, c, r != q ? q : null), !l.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && l.append(k.createText(" ")), l.append(a.listNode), a = a.nextIndex;
            ...
            exec: function(b) {
              ...
              if (this.state == CKEDITOR.TRISTATE_OFF) {
                ...
                if (f.getFirst(u)) {
                  ...
                  m.enterMode == CKEDITOR.ENTER_BR ? f.appendBogus() : c[0].fixBlock(1, m.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), e.selectRanges(c);
              }
              for (var m = e.createBookmarks(!0),
                  f = [],
                  k = {},
                  c = c.createIterator(),
                ...
                for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; d = g.getNextParagraph(); )
                  if (!d.getCustomData("list_block")) {
                    ...
                    for (var l = b.elementPath(d),
                        a = l.elements,
                        p = 0,
                        l = l.blockLimit,
                        q,
                        n = a.length - 1; 0 <= n && (q = a[n]); n--)
                ...
                if ("wysiwyg" == b.mode && e in {
                  ...
                  if (f && f.collapsed) {
                    ...
                    if (k) {
                      ...
                      d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.is(v) && (a = a.getFirst(u), g.block && f.checkStartOfBlock() && f.checkEndOfBlock() ? (g.block.remove(), f.moveToElementEditStart(a), f.select()) : A(a) ? (f.moveToElementEditStart(a), f.select()) : (f = f.clone(), f.moveToElementEditStart(a), C(b, e, f)), m.cancel());
                    setTimeout(function() {
                      b.selectionChange(1);
                    });
                  }
        ...
        CKEDITOR.plugins.removeformat = {
          commands: {removeformat: {exec: function(a) {
                for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")),
                  ...
                  var l = c.createBookmark(),
                      ...
                      d = l.endNode,
                      k = function(b) {
                        for (var c = a.elementPath(b),
                            e = c.elements,
                            d = 1,
                            g; (g = e[d]) && !g.equals(c.block) && !g.equals(c.blockLimit); d++)
                  ...
                  if (d)
                    for (k(d), b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d); )
                      if (b.isReadOnly()) {
                        ...
                        k = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == b.getName() && b.data("cke-realelement") || !f(a, b) || (h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(e), a.fire("removeFormatCleanup", b))), b = k;
                  c.moveToBookmark(l);
                }
                a.forceNextSelectionCheck();
          ...
          filter: function(a, h) {
            for (var e = a._.removeFormatFilters || [],
                f = 0; f < e.length; f++)
              if (!1 === e[f](h))
                return !1;
            return !0;
            ...
            update: function(a) {
              if (!this.locked) {
                ...
                for (var b = this.index,
                    c = this.snapshots; 0 < b && this.currentImage.equalsContent(c[b - 1]); )
                  --b;
 ...
 while ((!a || a.type != CKEDITOR.NODE_ELEMENT || "true" != a.getAttribute("contenteditable")) && (a = a.getParent()));
            ...
            greedySearch: function() {
              this.relations = {};
              for (var a = this.editable.getElementsByTag("*"),
                  d = 0,
                  b,
                  c,
                  e; b = a.getItem(d++); )
          ...
          p.prototype = {
            ...
            getStyle: function(a, d) {
              ...
              if (e.top - this.winTopScroll.y < this.rect.top || e.top - this.winTopScroll.y > this.rect.bottom)
                return !1;
              ...
              for (var g in e)
                e[g] = CKEDITOR.tools.cssLength(e[g]);
              return e;
            },
            addLine: function() {
        ...
        (function() {
          ...
          function P(a, b) {
            ...
            if (d)
              if ("string" == typeof d)
                for (d = d.split(","); d.length; )
                  c(b.upcasts[d.pop()], b.name, e);
              else
                c(d, b.name, e);
          }
          function t(a, b) {
          ...
          function R(a) {
            ...
            return {
              ...
              iterator: function(a) {
                ...
                if ("data-widget" in a.attributes)
                  return b.push([a]), !1;
                if (m = c.length) {
                  if (a.attributes["data-cke-widget-upcasted"])
                    return !1;
                  k = 0;
                  ...
                  for (k = 0; k < m; ++k)
                    if (f = c[k], l = {}, h = f[0](a, l))
                      return h instanceof CKEDITOR.htmlParser.element && (a = h), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(l)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1;
                }
              }
            };
          }
          ...
          function L(a) {
            ...
            b.on("contentDom", function() {
              ...
              CKEDITOR.tools.extend(a, {
                finder: new c.finder(b, {lookups: {"default": function(c) {
              ...
              b.data.dataValue.forEach(function(c) {
                ...
                if ("data-cke-widget-id" in b) {
                  if (b = a.instances[b["data-cke-widget-id"]])
                    d = c.getFirst(g.isParserWidgetElement), f.push({
                      wrapper: c,
                      element: d,
                      widget: b,
                      editables: {}
                  ...
                  return f[f.length - 1].editables[b["data-cke-widget-editable"]] = c, !1;
              }, CKEDITOR.NODE_ELEMENT, !0);
            }, null, null, 8);
            b.on("toDataFormat", function(a) {
              if (a.data.downcastingSessionId) {
                ...
                for (var b,
                  ...
                  for (m in b.editables)
                    g = b.editables[m], delete g.attributes.contenteditable, g.setHtml(f.editables[m].getData());
                  l || (l = h);
            ...
            b.on("dataReady", function() {
              if (d)
                for (var c = b.editable().find(".cke_widget_wrapper"),
                    ...
                    l = 0,
                    k = c.count(); l < k; ++l)
                  f = c.getItem(l), h = f.getFirst(g.isDomWidgetElement), h.type == CKEDITOR.NODE_ELEMENT && h.data("widget") ? (h.replace(f), a.wrapElement(h)) : f.remove();
              d = 0;
              a.destroyAll(!0);
              a.initOnAll();
            });
            ...
            return {
              ...
              commit: function() {
                ...
                for (f && (h = a.focused) && t(a, h); h = d.pop(); )
                  b.splice(CKEDITOR.tools.indexOf(b, h), 1), h.isInited() && (g = h.editor.checkDirty(), h.setSelected(!1), !g && h.editor.resetDirty());
                f && e && (g = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", {widget: e}), e.setFocused(!0), !g && a.editor.resetDirty());
                for (; h = c.pop(); )
                  b.push(h), h.setSelected(!0);
          ...
          function W(a) {
            if (a.draggable) {
              ...
              if (!a.inline && (d.on("mousedown", X, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version))
          ...
          function X(a) {
            ...
            var m = c.greedySearch(),
                n = CKEDITOR.tools.eventsBuffer(50, function() {
                  p = d.locate(m);
                  k = d.sort(q, 1);
                  k.length && (e.prepare(m, p), e.placeLine(k[0]), e.cleanup());
                }),
                p,
                q;
          ...
          function Y(a) {
            ...
            if (a.editables)
              for (b in d)
                c = d[b], a.initEditable(b, "string" == typeof c ? {selector: c} : c);
          }
          function Z(a) {
            if (a.mask) {
          ...
          function aa(a) {
            if (a.parts) {
              var b = {},
                  ...
                  d;
              for (d in a.parts)
                c = a.wrapper.findOne(a.parts[d]), b[d] = c;
              a.parts = b;
            }
          }
          function N(a, b) {
            ...
            if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version)
              a.wrapper.on("dragstart", function(c) {
            ...
            a.on("key", function(b) {
              ...
              if (13 == b)
                ...
                if (b in ca || CKEDITOR.CTRL & b || CKEDITOR.ALT & b)
                  return;
              }
              return !1;
            }, null, null, 999);
          ...
          CKEDITOR.plugins.add("widget", {
            ...
            afterInit: function(a) {
              var b = a.widgets.registered,
                  ...
                  e;
              for (d in b)
                c = b[d], (e = c.button) && a.ui.addButton && a.ui.addButton(CKEDITOR.tools.capitalize(c.name, !0), {
                  label: e,
                  command: c.name,
                  toolbar: "insert,10"
                });
 ...
 while (b && !b.equals(f) && !(e = a(b)));
            ...
            initOnAll: function(a) {
              ...
              for (var b = [],
                  c,
                  d = a.count(); d--; )
                (c = this.initOn(a.getItem(d).getFirst(g.isDomWidgetElement))) && b.push(c);
              return b;
            },
            onWidget: function(a) {
            ...
            wrapElement: function(a, b) {
              ...
              if (a instanceof CKEDITOR.dom.element) {
                ...
                if (!d)
                  return null;
                if ((c = a.getParent()) && c.type == CKEDITOR.NODE_ELEMENT && c.data("cke-widget-wrapper"))
                  return c;
                ...
                if (!d)
                  return null;
                if ((c = a.parent) && c.type == CKEDITOR.NODE_ELEMENT && c.attributes["data-cke-widget-wrapper"])
                  return c;
          ...
          g.prototype = {
            ...
            destroy: function(a) {
              this.fire("destroy");
              if (this.editables)
                for (var b in this.editables)
                  this.destroyEditable(b, a);
            ...
            edit: function() {
              var a = {dialog: this.dialog},
                  b = this;
              if (!1 === this.fire("edit", a) || !a.dialog)
                return !1;
            ...
            initEditable: function(a, b) {
              ...
              return c && c.is(CKEDITOR.dtd.$editable) ? (c = new q(this.editor, c, {filter: u.call(this.repository, this.name, a, b)}), this.editables[a] = c, c.setAttributes({
                contenteditable: "true",
                "data-cke-widget-editable": a,
                "data-cke-enter-mode": c.enterMode
              }), c.filter && c.data("cke-filter", c.filter.id), c.addClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), b.pathName && c.data("cke-display-name", b.pathName), this.editor.focusManager.add(c), c.on("focus", E, this), CKEDITOR.env.ie && c.on("blur", D, this), c._.initialSetData = !0, c.setData(c.getHtml()), !0) : !1;
            },
            _findOneNotNested: function(a) {
              ...
              for (var b,
                  c,
                  d = 0; d < a.count(); d++)
                if (b = a.getItem(d), c = b.getAscendant(g.isDomWidgetWrapper), this.wrapper.equals(c))
                  return b;
              return null;
            },
            isInited: function() {
        ...
        CKEDITOR.config.plugins = 'basicstyles,blockquote,dialogui,dialog,clipboard,enterkey,horizontalrule,indent,indentlist,justify,list,pastefromword,removeformat,tab,undo,lineutils,widget';
